...
class PasswordField extends StatefulWidget {
  ...
  /// A FocusNode for passwordField.
  final FocusNode? focusNode;

  /// A FocusNode for passwordField.
  final FocusNode? nextFocusNode;

  /// A keyboardType for  passwordField.
  final TextInputType ?keyboardType;

  /// A keyboardType for  passwordField.
  final TextAlign ?textAlign;

  /// A readOnly for  passwordField.

  final bool ?readOnly ;

  /// A maxLines for  passwordField.

  final int maxLines ;

  /// A minLines for  passwordField.
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          return Container(
            ...
            child: TextField(
              ...
              obscureText: widget.suffixIconEnabled! ? obscureText : false,
              ...
              onSubmitted: (val) {
                ...
                bloc.onPasswordChanged(widget.pattern ?? '.*', widget.controller.text);
              },
